...
class GameMenuControl {
    ...
    private boolean isTie() {
        ...
        for (Location[] rowLocations : locations) {
            ...
            for (int col = 0; col < rowLocations.length; col++) {
                battleship1.Location location = rowLocations[col]; // get contents of cell
                if (rowLocations[col].player == null) {
     ...
     */
    private boolean threeInARow(int row, int col, battleship1.Location[][] boardLocations) {
    ...
    public void clearTheBoard() {
        battleship1.Location[][] locations = this.game.board.boardLocations;
        
        for (int i = 0; i < this.board.boardLocations.length; i++) {
            battleship1.Location[] rowlocations = locations[i];
